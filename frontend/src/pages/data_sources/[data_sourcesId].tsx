...
const EditData_sources = () => {
  ...
  const { data_sourcesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: data_sourcesId }))
  }, [data_sourcesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: data_sourcesId, data }))
...
EditData_sources.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditData_sources
