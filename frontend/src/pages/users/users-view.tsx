            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>Pots</p>
                        ...
                        <p>{users?.pots?.name ?? 'No data'}</p>

                </div>

                <>
                    <p className={'block font-bold mb-2'}>Alerts User</p>
                    <CardBox
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.alerts_user && Array.isArray(users.alerts_user) &&
                              users.alerts_user.map((item: any) => (
                        ...
                        {!users?.alerts_user?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
